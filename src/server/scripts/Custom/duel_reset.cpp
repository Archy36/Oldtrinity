        ...
        { 
            ...
            { 
                ...
                { 
					...
					winner->RemoveAura(57723);
					winner->RemoveAura(57724);
					winner->RemoveAura(25771);
					winner->RemoveAura(41425);
					winner->RemoveAura(61987);
					winner->RemoveAura(66233);
					winner->RemoveAura(11196);
					winner->RemoveAura(14177);
					looser->RemoveAura(57723);
					looser->RemoveAura(57724);
					looser->RemoveAura(25771);
					looser->RemoveAura(41425);
					looser->RemoveAura(61987);
					looser->RemoveAura(66233);
					looser->RemoveAura(11196);
					looser->RemoveAura(14177);
