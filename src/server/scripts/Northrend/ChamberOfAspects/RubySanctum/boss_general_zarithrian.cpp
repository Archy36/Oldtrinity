...
Position const FlamecallerWaypoints[MAX_PATH_FLAMECALLER_WAYPOINTS*2] =
{
    ...
    {3007.479f, 514.2192f, 89.56694f, 0.0f},
    {3009.403f, 530.8093f, 89.28233f, 0.0f},
	{3045.830f, 531.7816f, 89.33438f, 0.0f},
    // West
    ...
    {3009.403f, 530.7093f, 89.28233f, 0.0f},
	{3046.560f, 544.0698f, 89.97866f, 0.0f},
};
