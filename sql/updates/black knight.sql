...
SET @OGUID=400000; -- Need 10
SET @CGUID=400000; -- Need 3
...
(@CGUID+0,33537,571,1,1,0,9071.043,2075.388,67.21542,4.935980,120,0,0,1,0,0,0,0,0),
(@CGUID+1,33537,571,1,1,0,9074.414,2049.259,67.34636,2.181662,120,0,0,1,0,0,0,0,0),
(@CGUID+2,33537,571,1,1,0,9081.280,2058.925,67.38979,3.612832,120,0,0,1,0,0,0,0,0);

-- Template updates
UPDATE creature_template SET unit_flags=unit_flags|8,speed_run=4, InhabitType=5 WHERE entry=33519; -- Black Knight''s Gryphon
UPDATE creature_template SET faction_A=2080,faction_H=2080,unit_flags=unit_flags|32768 WHERE entry=33537; -- Cult Conspirator
...
(67471,4658,13663,13663,0,0,2,1,1,1); -- See Black Knight Invis
